...
public class SoftKeyboardUtils {
    ...
    public static void dismissSoftKeyboard(final Context activity, final EditText text) {
        if (activity != null) {
            InputMethodManager imm = (InputMethodManager) activity.getSystemService(Context.INPUT_METHOD_SERVICE);
            try {
    ...
    public static void hideInputKeyBoard(Context mContext,EditText mEditText) {
        InputMethodManager imm = (InputMethodManager)mContext.getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.hideSoftInputFromWindow(mEditText.getWindowToken(), 0);
        mEditText.clearFocus();
    }

    public static void showInputKeyBoard(Context mContext,EditText mEditText) {
