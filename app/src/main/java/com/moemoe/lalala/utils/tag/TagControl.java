...
import com.moemoe.lalala.model.entity.tag.FontUrlSpan;
...
public class TagControl {
    ...
    public void init(Context context){
        ...
        tag.setSpan(new FontUrlSpan(context,tag));
        attrs = new HashMap<>();
        attrs.put("color","");
        tag.setAttrs(attrs);
        tags.add(tag);
            ...
            for(HashMap<String,String> attrMap : map.getFirstKeys()){
                ...
                for(Integer begin : concurrentHashMap.keySet()){
                    ...
                    if(tag.getSpan() instanceof UserUrlSpan){
                        ...
                        tag1.setSpan(span);
                    }else if(tag.getSpan() instanceof ImageUrlSpan) {
                        span = new ImageUrlSpan(context,attrMap.get("path"),tag1);
                        tag1.setSpan(span);
                    }else {
                        span = new FontUrlSpan(context,attrMap.get("color"),tag1);
                        tag1.setSpan(span);
                    }
