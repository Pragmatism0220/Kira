 ...
 */
public class FolderDecorationNew extends RecyclerView.ItemDecoration {


    public FolderDecorationNew() {
...
//                outRect.top = view.getContext().getResources().getDimensionPixelSize(R.dimen.size_0);
//            }
            outRect.left = x24;
            outRect.right = x4;
