...
//		height = drawable.getIntrinsicHeight();
	 ...
	 * ensure that geo area is configured in /assets/map/dormitory_asa.xml file.
	 * @param location - location of the object.
	 * @throws IllegalStateException if geo area is not configured in dormitory_asa.xml file.
	 * @see Location
	 */
