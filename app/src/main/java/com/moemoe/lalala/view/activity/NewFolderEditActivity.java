...
public class NewFolderEditActivity extends BaseAppCompatActivity implements NewFolderEditContract.View {
    ...
    @OnClick({R.id.tv_menu, R.id.ll_name_root, R.id.ll_bg_root, R.id.ll_coin_root, R.id.tv_label_add_1, R.id.tv_label_add_2, R.id.tv_label_add_3, R.id.ll_sort_root})
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_menu:
                done();
            ...
            case R.id.tv_label_add_2:
                ...
                break;
            case R.id.tv_label_add_3:
                Intent i3 = new Intent(NewFolderEditActivity.this, RecommendTagActivity.class);
