...
public class DownloadListV2Holder extends ClickableViewHolder {
...
//    private RxDownload mRxDownload;
    ...
    public DownloadListV2Holder(View itemView, BaseRecyclerViewAdapter adapter) {
        super(itemView);
        mImg = $(R.id.img);
    ...
    public void updateDownloaded() {
        ...
        mActionButton.setTextColor(getResources().getColor(R.color.green_6fc93a));
    }
    ...
    public void updateNotDownloaded(final int status, final long sofar, final long total) {
        ...
        mActionButton.setTextColor(getResources().getColor(R.color.colorAccent));
    }
    ...
    public void createItem(final DownloadEntity param, int position) {
        ...
        if (TextUtils.isEmpty(param.getUrl())) {
            ...
            try {
                JSONObject object = new JSONObject(param.getAttr());
                Glide.with(context)
                        .load(StringUtils.getUrl(context, object.getString("cover"), (int) context.getResources().getDimension(R.dimen.y100), (int) context.getResources().getDimension(R.dimen.y100), false, true))
        ...
        if (status == FileDownloadStatus.pending || status == FileDownloadStatus.started ||
            ...
            TasksManager.getImpl()
                    .updateViewVv2Holder(id, this);
            task.setListener(((DownloadListV2Adapter) mAdapter).taskDownloadListener);
...
//            task.start();
        ...
        mActionButton.setOnClickListener(((DownloadListV2Adapter) mAdapter).taskActionOnClickListener);
