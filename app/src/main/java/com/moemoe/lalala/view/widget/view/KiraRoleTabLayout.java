...
public class KiraRoleTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener{
    ...
    public KiraRoleTabLayout(Context context) {
        this(context,null);
    }

    public KiraRoleTabLayout(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public KiraRoleTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context,AttributeSet attrs){
        ...
        mTabLayoutId = a.getResourceId(R.styleable.KiraTabLayout_kira_tl_tab_layout,R.layout.item_tab_normal_role);
