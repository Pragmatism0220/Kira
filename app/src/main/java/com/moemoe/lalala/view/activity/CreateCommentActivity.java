...
public class CreateCommentActivity extends BaseAppCompatActivity implements CreateCommentContract.View{
    ...
    public static void startActivity(Context context,String id,boolean isSec,String commentTo,int commentType){
    ...
    private void done(){
        ...
        mPresenter.createComment(isSec,mId,entity,mPaths,commentType);
    }
