...
// */
//
//public class BottomMenuV2Fragment extends DialogFragment {
//
...
//    private PullAndLoadView rv;
//
//    public BottomMenuV2Fragment() {
...
//                BottomMenuV2Fragment.this.dismiss();
//            }
//        });
//
...
//        }
//
//        rv = (PullAndLoadView) view.findViewById(R.id.rv_menu);
...
//            rv.getRecyclerView().addItemDecoration(new MenuHItemDecoration(getResources().getDimensionPixelSize(R.dimen.y36), getResources().getDimensionPixelSize(R.dimen.x24)));
//        }
...
//            }
//        });
//        rv.getRecyclerView().setAdapter(menuItemAdapter);
//
//        return view;
//    }
//
//    public PullAndLoadView getListView() {
//        return rv;
//    }
//
