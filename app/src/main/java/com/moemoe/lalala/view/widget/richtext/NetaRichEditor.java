...
public class NetaRichEditor extends ScrollView {
    ...
    private LinearLayout mTvAddCover;
    ...
    public NetaRichEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        root.setPadding(0, 0, 0, 0);//设置间距，防止生成图片时文字太靠边，不能用margin，否则有黑边
    ...
    public void createFirstEdit() {
        ...
        final EditText firstEdit = createEditText("正文内容");
    ...
    public void setHintTile() {
        mEtTitle.setText("");
        mEtTitle.setHint(getResources().getString(R.string.label_edit_doc_hint));
        mTvTitleCount.setText("30");
    }

    public void setLastFocusEdit() {
        lastFocusEdit.setText("");
        lastFocusEdit.setHint("正文内容");
    }
    ...
    public void setCover(String path) {
        ...
        if (TextUtils.isEmpty(path)) {
            int w = (int) DensityUtil.getScreenWidth(getContext());
            int h = (int) (int) getResources().getDimension(R.dimen.y120);
            Glide.with(getContext())
                    .load(path)
                    .error(R.drawable.shape_dash_gray_d7d7d7)
                    .placeholder(R.drawable.shape_dash_gray_d7d7d7)
                    .bitmapTransform(new CropTransformation(getContext(), w, h))
                    .into(mCover);
            mTvAddCover.setVisibility(VISIBLE);
        } else {
            int w = (int) (DensityUtil.getScreenWidth(getContext()) - getContext().getResources().getDimension(R.dimen.x36) * 2);
            int h = (int) getContext().getResources().getDimension(R.dimen.y400);
            Glide.with(getContext())
                    .load(path)
...
//    }
    ...
    public void removeImageVieweList() {
