...
public class FeedFollowV3Fragment extends BaseFragment implements FeedFollowContract.View {
    ...
    View mAlpha;
    @BindView(R.id.iv_show_all_follow_tag)
    View mSwitchTag;
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        mSwitchTag.setOnClickListener(new NoDoubleClickListener(500) {
            @Override
            public void onNoDoubleClick(View v) {
    ...
    @OnClick({R.id.iv_add_follow_tag, R.id.view_alpha})
    ...
    public void onLoadUserTagsSuccess(final ArrayList<UserFollowTagEntity> entities) {
        ...
        for (int i = 0; i < mUserTags.size(); i++) {
            ...
            if (mUserTags.get(i).getNum() != 0) {
                View view = mTabLayout.getTabView(i);
                TextView tv = view.findViewById(R.id.tv_tab_msg);
                tv.setVisibility(View.VISIBLE);
                tv.setText(mUserTags.get(i).getNum() + "");
            }
