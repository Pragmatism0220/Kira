...
//                ((PhoneMainV2Activity)getContext()).toFragment(juQingChatFragment);
                ChatActivity.startActivity(getContext(),role,id[0],"JuQing");
            }
        }
    }
    ...
    public boolean onConversationClick(Context context, View view, UIConversation uiConversation) {
        if("len".equals(uiConversation.getUIConversationTitle())){
            ...
            ChatActivity.startActivity(getContext(),"","","MsgV2");
//            ((PhoneMainV2Activity)getContext()).toFragment(PhoneMsgListV2Fragment.newInstance());
            ...
            ChatActivity.startActivity(getContext(),uiConversation.getConversationTargetId(),uiConversation.getUIConversationTitle(),uiConversation.getConversationType().getName(),getContext().getApplicationInfo().packageName,"KiraConversation");
