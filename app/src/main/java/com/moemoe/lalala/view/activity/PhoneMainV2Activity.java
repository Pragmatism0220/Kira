...
//            startActivity(i);
    ...
    protected void initListeners() {
        ...
        mTvShowLive2d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //埋点统计：陪伴模式
                clickEvent("同桌-陪睡模式");
                Intent i = new Intent(PhoneMainV2Activity.this, Live2dActivity.class);
                startActivity(i);
            }
        });
    }
    ...
    private void clickRole() {
        ...
        if (mIvRole.isSelected()) {
            ...
            mTvShowLive2d.setVisibility(View.VISIBLE);
            ...
            mIvCreatDynamic.setVisibility(View.GONE);
            mTvShowLive2d.setVisibility(View.GONE);
...
//                    toFragment(PhoneMenuV2Fragment.newInstance());
                    Intent intent = new Intent(this, PhoneMenuV3Activity.class);
            ...
            case R.id.ll_bag_root:
                if (NetworkUtils.checkNetworkAndShowError(this) && DialogUtils.checkLoginAndShowDlg(PhoneMainV2Activity.this)) {
                    ...
                    if (PreferenceUtils.getAuthorInfo().isOpenBag()) {
                        ...
                        startActivity(i2);
//                        Intent i2 = new Intent(this, NewBagV5Activity.class);
//                        startActivity(i2);
                    } else {
