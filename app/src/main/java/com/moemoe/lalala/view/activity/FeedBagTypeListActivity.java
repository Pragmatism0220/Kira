...
public class FeedBagTypeListActivity extends BaseAppCompatActivity implements FeedBagContract.View{
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        if(type.equals(FolderType.ZH.toString())){
            ...
            mTitle.setText("音乐");
        }else if(type.equals(FolderType.MOVIE.toString())){
            mTitle.setText("视频");
        }
        ...
        mAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                }else if(entity.getType().equals(FolderType.MUSIC.toString())){
                    KiraMusicActivity.startActivity(FeedBagTypeListActivity.this,entity.getUuid(),entity.getFolderId(),entity.getFolderName(),entity.getCover());
                }else if(entity.getType().equals(FolderType.MOVIE.toString())){
                    KiraVideoActivity.startActivity(FeedBagTypeListActivity.this,entity.getUuid(),entity.getFolderId(),entity.getFolderName(),entity.getCover());
                }
            }
