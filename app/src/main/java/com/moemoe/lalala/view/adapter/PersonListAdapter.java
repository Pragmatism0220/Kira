    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if(mType == 0 || mType == 10){
            ...
            if(entity.getType().equals(FolderType.ZH.toString())){
                ...
                viewHolder.tvMark.setText("视频集");
                viewHolder.tvMark.setBackgroundResource(R.drawable.shape_rect_shipin);
            }else if(entity.getType().equals(FolderType.YY.toString())){
                viewHolder.tvMark.setText("音乐集");
                viewHolder.tvMark.setBackgroundResource(R.drawable.shape_rect_yinyue);
            }else {
