...
public class CommentListActivity extends BaseAppCompatActivity implements CommentsListContract.View{
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        mTvToComment.setOnClickListener(new NoDoubleClickListener() {
            ...
            public void onNoDoubleClick(View v) {
                CreateCommentActivity.startActivity(CommentListActivity.this,mDocId,false,"",0);
            }
        });
    ...
    public void favoriteComment(FavoriteCommentEvent event){
        mPresenter.favoriteComment(mDocId,event.getCommentId(),event.isFav(),event.getPosition());
    }
    ...
    private void showCommentMenu(final CommentV2Entity bean, final int position){
        ...
        fragment.setmClickListener(new BottomMenuFragment.MenuItemClickListener() {
            ...
            public void OnMenuItemClick(int itemId) {
                if (itemId == 0) {
                    CreateCommentActivity.startActivity(CommentListActivity.this,bean.getCommentId(),true,bean.getCreateUser().getUserId(),0);
                } else if (itemId == 2) {
