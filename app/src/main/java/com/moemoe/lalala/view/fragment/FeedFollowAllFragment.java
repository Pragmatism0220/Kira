...
import com.moemoe.lalala.view.activity.MengXinActivity;
        ...
        mAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if(entity.getType().equals(FolderType.ZH.toString())){
                    ...
                    KiraVideoActivity.startActivity(getContext(),entity.getFolderId(),entity.getId(),entity.getTitle(),entity.getCover());
