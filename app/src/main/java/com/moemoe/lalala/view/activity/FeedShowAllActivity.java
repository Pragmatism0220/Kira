...
public class FeedShowAllActivity extends BaseAppCompatActivity implements FeedShowAllContract.View {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("title").equals("文章")) {
            mListDocs.setPadding(0, (int) getResources().getDimension(R.dimen.x24), 0, 0);
        }
                ...
                if (mIsSelect) {
                    ...
                    if (item instanceof ShowFolderEntity) {
                        ...
                        if (entity.getType().equals("ZH")) {
                            ...
                            KiraVideoActivity.startActivity(FeedShowAllActivity.this,entity.getUuid(),entity.getFolderId(),entity.getFolderName(),entity.getCover());
                        }
                    }else {
                        FeedFollowType1Entity entity = (FeedFollowType1Entity) item;
                        if(FolderType.MUSIC.toString().equals(entity.getType())){
                            KiraMusicActivity.startActivity(FeedShowAllActivity.this,entity.getFolderId(),entity.getId(),entity.getTitle(),entity.getCover());
