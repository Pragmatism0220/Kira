...
public class KiraShopTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public KiraShopTabLayout(Context context) {
        this(context, null);
    }

    public KiraShopTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KiraShopTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTabLayoutId = a.getResourceId(R.styleable.KiraTabLayout_kira_tl_tab_layout, R.layout.tag_shopping);
