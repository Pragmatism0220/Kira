...
public class BagMyViewHolder extends ClickableViewHolder {
    ...
    public void createItem(final BagMyShowEntity entity, final int position, final String userId, final String type, final String sign) {
        ...
        if (entity.getNum() > 0) {
            ...
            tvMore.setOnClickListener(new NoDoubleClickListener() {
                ...
                public void onNoDoubleClick(View v) {
                    ...
                    if (position == 0) {
                        NewFolderActivity.startActivity(itemView.getContext(), userId, FolderType.ZH.toString(), ty);
                    } else if (position == 1) {
                        NewFolderActivity.startActivity(itemView.getContext(), userId, FolderType.TJ.toString(), ty);
                    } else if (position == 2) {
                        NewFolderActivity.startActivity(itemView.getContext(), userId, FolderType.MH.toString(), ty);
                    } else if (position == 3) {
                        NewFolderActivity.startActivity(itemView.getContext(), userId, FolderType.XS.toString(), ty);
                    } else if (position == 4) {
                        NewFolderActivity.startActivity(itemView.getContext(), userId, FolderType.SP.toString(), ty);
                    } else if (position == 5) {
                        NewFolderActivity.startActivity(itemView.getContext(), userId, FolderType.YY.toString(), ty);
                    } else if (position == 6) {
                        NewFolderWenZhangActivity.startActivity(itemView.getContext(), userId, FolderType.WZ.toString(), ty, false);
                    }
                }
            });
            for (int n = 0; n < entity.getItems().size(); n++) {
                ...
                v.setOnClickListener(new NoDoubleClickListener() {
                    ...
                    public void onNoDoubleClick(View v) {
                        ...
                        } else if (entity.getTitle().equals("文章")) {
