...
//        View inflate = LayoutInflater.from(activity).inflate(R.layout.dialog_tags_doc, null);
//        TextView mTvCancel = inflate.findViewById(R.id.tv_cancel);
//        RecyclerView mListDosc = inflate.findViewById(R.id.rl_list);
//
...
//        mListDosc.setLayoutManager(linearLayoutManager);
